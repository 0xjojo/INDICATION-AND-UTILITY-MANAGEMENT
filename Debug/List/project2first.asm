...
_0x0:
	...
	.DB  0x0,0x25,0x69,0x43,0x0,0x25,0x69,0x0
	.DB  0x25,0x69,0x53,0x54,0x44,0x0,0x46,0x55
	.DB  0x4C,0x4C,0x0,0x20,0x20,0x20,0x20,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0085 	lcd_puts(str_sec);
	LDI  R26,LOW(_str_sec)
	LDI  R27,HIGH(_str_sec)
	RCALL _lcd_puts
; 0000 0086 
...
; 0000 0088 	lcd_puts(str_min);
	LDI  R26,LOW(_str_min)
	LDI  R27,HIGH(_str_min)
	RCALL _lcd_puts
; 0000 0089 	lcd_gotoxy(4, 0);
	RCALL SUBOPT_0x0
; 0000 008A 	lcd_puts(str_hour);
	LDI  R26,LOW(_str_hour)
	LDI  R27,HIGH(_str_hour)
	RCALL _lcd_puts
